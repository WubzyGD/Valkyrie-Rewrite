...
module.exports = {
    ...
    execute(message, msg, args, cmd, prefix, mention, client) {
        ...
        if (args.length) {
            ...
            if (options.reason && options.reason.length > 250) {return message.channel.send("\*Head scratching* ummm this is a coin flip, I don't think it's really necessary to write an essay on why you're flipping it...");}
            if (options.against && options.against.length > 35) {return message.channel.send("Does whoever you're flipping a coin with have some kind of nickname you can use instead? The one you gave me is too long for me to remember.");}
        }
